...
import ConsultRecord from './ConsultRecord.vue';
    ...
    <div class="flex h-full flex-col gap-3">
      ...
      <div class="flex-1 overflow-x-hidden bg-white pb-5 pt-2">
        <div class="relative h-full w-full">
          ...
          <div
            class="absolute right-7 top-1.5 cursor-pointer rounded-md bg-[#04DC70] px-3 py-1.5 text-sm text-white hover:bg-[#04DC70]/80"
          >
            导出信息
          </div>
        </div>
